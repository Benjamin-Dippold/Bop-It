...
public class MainActivity extends AppCompatActivity {
    ...
    public void giveRandomPrompt(View v) {
        ...
        Class<? extends AbstractPrompt>[] possiblePrompts = new Class[]{FlingPrompt.class, TapPrompt.class, DoubleTapPrompt.class, HoldPrompt.class};
    ...
    public void swapFragmentTo(Class<? extends Fragment> targetFragment) {
        try {
            ...
            fragmentTransaction.replace(fragmentContainerView.getId(), targetFragment.newInstance());
